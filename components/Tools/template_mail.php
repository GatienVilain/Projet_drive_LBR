                    ...
                    <tr>
                        <td style="text-align:center;">
                          <a href="" title="logo" target="_blank">
                            <img width="30%" src="https://www.lesbriquesrouges.fr/_nuxt/img/lesbriquesrougesRedWhite.43247f2.png" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Information Drive Les Briques Rouges</h1>
                                        <span
