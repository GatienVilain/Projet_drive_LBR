...
function creerMiniatureImage($imagePath)
{
    if(!empty($imagePath))
    {
        ...
        if(in_array($ext, $allow_ext))
        {
            ...
            $miniaturePath = pathinfo($imagePath, PATHINFO_DIRNAME).DIRECTORY_SEPARATOR."miniature".DIRECTORY_SEPARATOR.pathinfo($imagePath, PATHINFO_FILENAME)."_".(string)$modwidth."x".(string)$modheight.".".$ext;
...
function afficherMiniature($imagePath)
{
    echo('<br><img src="' . $imagePath . '" WIDTH=194 HEIGHT=90></br>');
}
