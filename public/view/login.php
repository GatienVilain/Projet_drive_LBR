...
<article id="login">
    ...
    <form action="index.php?action=login" method="post">
        ...
        <div id="login-email">
            ...
            <input type="email" name="email" id="email-field" value='<?php echo $mail_memoire; ?>' required>
        </div>
        <div id="login-password">
            <label for="password-field">Entrer votre mot de passe : </label>
            <input type="password" name="password" id="password-field" value='<?php echo $mdp_memoire; ?>' required>
